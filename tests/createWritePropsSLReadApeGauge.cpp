...
int main(int argc, char **argv)
{
  ...
  inv_param.matpc_type = QUDA_MATPC_EVEN_EVEN; // !!!!!!!!!!!! check if we need to change to QUDA_MATPC_EVEN_EVEN
  ...
  // perform inversions to create propagators
  invertWritePropsNoApe_SL_v2(gauge,gauge_APE,&inv_param,&gauge_param,info.sourcePosition,prop_path);
