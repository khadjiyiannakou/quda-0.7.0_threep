...
int main(int argc, char **argv)
{
  ...
  DeflateAndInvert_twop(gauge_APE,&inv_param,&gauge_param,pathEigenValuesUp,pathEigenVectorsUp,pathEigenValuesDown,pathEigenVectorsDown,twop_filename,NeV,info);
