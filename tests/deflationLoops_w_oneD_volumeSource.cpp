...
int main(int argc, char **argv)
{
  ...
  DeflateAndInvert_loop_w_One_Der_volumeSource(gauge_Plaq,&inv_param,&gauge_param,pathEigenValuesUp,pathEigenVectorsUp,pathEigenValuesDown,pathEigenVectorsDown,loop_filename,NeV,Nstoch,seed,NdumpStep,info);
