...
int main(int argc, char **argv)
{
  ...
  info.lL[3] = tdim;
  info.Nsources = 1;
  info.sourcePosition[0][0] = src[0];
  info.sourcePosition[0][1] = src[1];
  info.sourcePosition[0][2] = src[2];
  info.sourcePosition[0][3] = src[3];
  info.Q_sq = Q_sq;
  ...
  // char pathIn[] = "/users/krikitos/test_deflation/8to4/tm_periodic/csw1p57551/theta1/up/ev.0000";
  // char pathOut[] = "/users/krikitos/test_deflation/8to4/tm_periodic/csw1p57551/theta1/up/test.dat";
  //char pathEigenValues[] = "/users/krikitos/test_deflation/8to4/tm_periodic/csw1p57551/theta1/up/evals.dat";
  //  char pathIn[] = "/users/krikitos/scratch/cA2.09.48/eigenVectors_Giannis/up/ev64.0240";
  // char pathOut[] = "/users/krikitos/scratch/cA2.09.48/eigenVectors_Giannis/invert.txt";
  // char pathEigenValues[] = "/users/krikitos/scratch/cA2.09.48/eigenVectors_Giannis/evals.txt";

  char pathIn[] = "/users/krikitos/scratch/cA2.09.48/eigenVectors_Abdou/eigenVector.0240.up";
  char pathOut[] = "/users/krikitos/scratch/cA2.09.48/eigenVectors_Abdou/Avec.out";
  char pathEigenValues[] = "/users/krikitos/scratch/cA2.09.48/eigenVectors_Abdou/evals.txt";

  checkEigenVectorQuda(gauge_Plaq,&inv_param,&gauge_param,pathEigenValues,pathIn,pathOut,1);
  ...
  //  checkDeflateAndInvert(gauge_Plaq,&inv_param,&gauge_param,pathEigenValues,pathIn,pathOut,NeV);
  freeGaugeQuda();
